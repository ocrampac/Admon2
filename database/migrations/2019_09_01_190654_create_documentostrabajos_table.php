...
class CreateDocumentostrabajosTable extends Migration {
	...
	public function up()
	{
		Schema::create('documentostrabajos', function(Blueprint $table)
		{
			$table->increments('id');
			$table->text('Titulo');
			$table->integer('autor_id')->unsigned()->index('autor_id');
			$table->text('TituloPublicacion', 65535);
	...
	{
		Schema::drop('documentostrabajos');
	}
