 ...
 * @property string $TituloPublicacion
 ...
 * @package App\Models
 */
class Documentotrabajo extends Eloquent
{
	use \Illuminate\Database\Eloquent\SoftDeletes;
	protected $table = 'documentostrabajos';
	protected $casts = [
		'autor_id' => 'int',
		'PaginaDe' => 'int',
		'PaginaA' => 'int',
	...
	public function autor_doctrabajos()
	{
		return $this->hasMany(\App\Models\AutorDoctrabajo::class, 'docTrabajo_id');
	}
}
